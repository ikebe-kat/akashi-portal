    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {["D02","D18","D49","D67"].includes(employee.employee_code) && <button onClick={() => router.push("/payroll")} style={{ padding: "4px 12px", borderRadius: "4px", border: `1px solid ${T.primary}`, backgroundColor: "#fff", color: T.primary, fontSize: 11, cursor: "pointer", fontWeight: 600 }}>給与計算</button>}
